    ...
    public void run() throws MqttException, InterruptedException {
        ...
        try {
            ...
            while (true) {
                ...
                System.out
                        .println("2 - Receber dados em tempo real de uma região específica (Norte, Sul, Leste, Oeste)");
                ...
                switch (option) {
                    ...
                    case 2:
                        ...
                        if (region.equals("norte") || region.equals("sul") || region.equals("leste")
                                || region.equals("oeste")) {
                ...
                System.out
                        .println("Aguardando dados em tempo real. Pressione Enter para mudar a assinatura ou sair...");
                scanner.nextLine();
